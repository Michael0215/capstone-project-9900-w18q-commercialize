...
public class FollowAdapter extends RecyclerView.Adapter<FollowAdapter.InnerHolder>{
    ...
    public FollowAdapter(List<ItemFollow> data){
        this.mData = data;
    }
    ...
    public InnerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view =  View.inflate(parent.getContext(), R.layout.item_container_following, null);
    ...
    public class InnerHolder extends RecyclerView.ViewHolder {
        ...
        //这个方法用于设置数据
        public void setData(ItemFollow itemFollow, int position) {
            this.mPosition = position;
            //开始设置数据
            mContributor.setText(itemFollow.tv_contributor_name);
            mAvatar.setImageBitmap(itemFollow.avatar);
        }
    }
}
